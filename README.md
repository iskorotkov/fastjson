...
Performance:
  ...
  - use iterators
  - rewrite encoder to allow Writer API when working with base64
  - add type aliases:
      1. ascii-only vs. utf string
      2. low cardinality vs. high cardinality string
      3. base64 byte array vs. other array encoding
      4. think about other types
